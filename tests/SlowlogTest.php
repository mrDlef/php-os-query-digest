...
final class SlowlogTest extends TestCase
{
    ...
    private const HASH = 'q3:fe168406e702';
    ...
    public function testTheRankingCanBeOrderedOnAnyColumn(): void
    {
        ...
        self::assertLessThan(strpos($byTotal, 'q3:5b2210eb5318'), (int) strpos($byTotal, self::HASH));
        self::assertLessThan(strpos($byMax, self::HASH), (int) strpos($byMax, 'q3:5b2210eb5318'));
        self::assertLessThan(strpos($byCount, 'q3:5b2210eb5318'), (int) strpos($byCount, self::HASH));
    ...
    public function testTopLimitsTheTableAndSaysWhatItLeftOut(): void
    {
        ...
        self::assertStringNotContainsString('q3:5b2210eb5318', $limited);
        self::assertStringContainsString('1 more shape (--top none for all)', $limited);
        self::assertStringContainsString('q3:5b2210eb5318', $all);
    ...
    public function testARecordWithoutADurationStillCountsAsOne(): void
    {
        ...
        self::assertMatchesRegularExpression('/\s1\s+-\s+-\s+-\s+-\s+q3:/', $out);
    }
    ...
    public function testMeanRanksTheShapeThatIsSlowEveryTimeAboveTheOneThatIsSlowOnce(): void
    {
        ...
        self::assertSame(Command::OK, $status);
        self::assertLessThan(strpos($out, 'q3:5b2210eb5318'), (int) strpos($out, self::HASH));
