...
```
q3:4dde138a2ad7   n=90   first seen 2026-08-19T15:00:00.000Z
...
```
14:00  q3:63a1ca5c80b9 goes from 50ms to 1074ms
15:00  the deploy — q3:4dde138a2ad7 appears
```
...
`q3:` → `q4:`, and every hash in the after-window is new by construction.

The prefix exists to make that visible rather than silent, and a signature that
did not change keeps its twelve hex characters — so `q3:abc…` and `q4:abc…` are
