...
```
q3:e9794c1be608   p95=1484ms   n=30    orders | q=(country:? and status:(? or ? or ? or ? or ? or +3))
q3:63a1ca5c80b9   p95=1019ms   n=360   logs-* | q=(@timestamp >= ? and env:?) | aggs=terms(host,10)>…
q3:4dde138a2ad7   p95=  30ms   n=90    products-v3 | q=(image_embedding:knn(k=?) and in_stock:? …)
```

The top answer is wrong. `q3:e9794c1be608` is a report over `orders` that takes
...
```
q3:63a1ca5c80b9   n=360     median=  47ms   total=118.6s
q3:fe168406e702   n=7200    median=   8ms   total= 57.6s
q3:e9794c1be608   n=30      median=1316ms   total= 39.5s
q3:4dde138a2ad7   n=90      median=  25ms   total=  2.3s
```
